...
####
run = '2017-Mar-30-run-14'   # data file base name
...
plt.savefig(run + 'Summary'+ '.pdf', dpi=300, orientation='landscape',\
 format='pdf', transparent=False, bbox_inches=None, pad_inches=0.05)
plt.show()
